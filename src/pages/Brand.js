...
import { PRODUCTS , CATEGORIES , BRANDS } from '../helpers/api'
...
class Brand extends Component {
    ...
    render() {
        ...
        const title = post ? (
            <IonLabel style={cssName.titleName} className="text-default" key={post.slug}>
                {post.name}
            </IonLabel>
        ) : null
                                ...
                                <IonRow>
                                    ...
                                    <IonCol className="px-0 text-center">
                                        <div className="d-flex h-100 justify-content-center align-items-center">                                           
                                            <MdFormatListBulleted size="1.1rem" className="text-default" />
